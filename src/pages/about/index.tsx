    ...
    <>
      ...
      <main class={s.main}>
        ...
        <section class={s.summary}>
          ...
          <For each={t.about.summary.text()}>{(p) => <p>{p}</p>}</For>
        </section>

        <section class={s.streams}>
          <h2>{t.about.streams.title()}</h2>
          <For each={t.about.streams.text()}>{(p) => <p>{p}</p>}</For>
        </section>

        <section class={s.adhoc}>
          <h2>{t.about.adhoc.title()}</h2>
          <For each={t.about.adhoc.text()}>{(p) => <p>{p}</p>}</For>
        </section>

        <section class={s.rhythm}>
          <h2>{t.about.rhythm.title()}</h2>
          <For each={t.about.rhythm.text()}>{(p) => <p>{p}</p>}</For>
        </section>

        <section class={s.ai}>
          <h2>{t.about.ai.title()}</h2>
          <For each={t.about.ai.text()}>{(p) => <p>{p}</p>}</For>
        </section>
      </main>
    </>
  );
